...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    tr.innerHTML = `
      <td class="user">
        <img src="https://github.com/4llves.png" alt="Imagem de 4llves">
        <a href="https://github.com/4llves" target="_blank">
          <p>Jhonata Alves</p>
          <span>4llves</span>
        </a>
      </td>
  ...
  // showNoFav() {
  //   this.nofav.querySelector('#no-favorites-hidden').id = 'no-favorites'
  // }
